        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
					...
					$status_wise_courses = $status_wise_courses['active']->num_rows();
					  $status_wise_courses = $this->db->count_all('course');
				$status_wise_courses++;
				// 	echo $status_wise_courses.' '.site_phrase('online_courses');
				    ?>
                                        
                                        <span><?php echo $status_wise_courses['active']->num_rows(); ?></span></h3>
                                        ...
                                        <td>
                                            <?php if ($course['is_free_course'] == null) : ?>
                                                <?php if ($course['discount_flag'] == 1) : ?>
                                                   <span class="badge badge-dark-lighten"><i class="fas fa-rupee-sign"></i> <?php echo  $course['discounted_price']; ?></span>
                                                <?php else : ?>
                                                    <span class="badge badge-dark-lighten"><i class="fas fa-rupee-sign"></i> <?php echo  $course['price']; ?></span>
                                                <?php endif; ?>
