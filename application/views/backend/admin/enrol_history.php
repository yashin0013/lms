...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
              <h4 class="mb-3 header-title"><?php echo get_phrase('enrol_history'); ?></h4>
              ...
              <div class="table-responsive-sm mt-4">
                  <?php if (count($enrol_history->result_array()) > 0): ?>
                      ...
                      <table id="example" class="table table-striped dt-responsive m-0 nowrap"  width="100px">
                          <thead width="100px">
                              <tr width="10px">
                          ...
                          <tbody>
                              <?php foreach ($enrol_history->result_array() as $enrol):
                                  ...
                                  <tr class="gradeU" >
                                      <td>
                                          <img src="<?php echo $this->user_model->get_user_image_url($enrol['user_id']); ?>" alt=""  class="img-fluid rounded-circle img-thumbnail" height="50px" width="50px">
                                      </td>
                                      <td>
