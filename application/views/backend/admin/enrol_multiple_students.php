...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('enrol_multiple_students'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
        ...
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                ...
                <form class="required-form" action="<?php echo site_url('admin/enrol_multiple_students/students'); ?>" method="post" enctype="multipart/form-data">
