...
class User_model extends CI_Model
{
    ...
    public function my_courses($user_id = "")
    {
        if ($user_id == "") {
            ...
            //$this->session->set_flashdata('flash_message', get_phrase('Congratulations on successfully raising ticket for live demo class for Dexito_s course name! Please fill the form'));
        }
