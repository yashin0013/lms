                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="user_cv"><?php echo get_phrase('user_cv'); ?></label>
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                  <div class="">
                                                      <span><b>Uploaded CV-</b> <?php echo $user_data['cv']; ?></span>
                                                  </div>
                                                 <div class="flex-grow-1 mt-1 pl-3">
                                                      <div class="input-group">
                                                          <div class="custom-file">
                                                              <input type="file" class="custom-file-input" name = "user_cv" id="user_cv" accept=".pdf*">
                                                              <label class="custom-file-label ellipsis" for="user_cv"><?php echo get_phrase('upload_new_cv'); ?></label>
                                                          </div>
                                                      </div>
                                                  </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="instagram_link" name="instagram_link" class="form-control" value="<?php echo $social_links['instagram']; ?>">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
