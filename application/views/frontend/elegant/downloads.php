...
.btn_1 {
  ...
  .app-icon {
    ...
    width: 10rem;
    height: 10rem;
    border-radius: 1.7543859649rem;
    background-color: #20BEFF;
    background: linear-gradient(to left top, #20beff, #37d9d5);
    overflow: hidden;
    box-shadow: 0 14px 33px rgba(32, 190, 255, 0.2);
  ...
  .icon-link:active {
    color: #fff;
    box-shadow: 0 14px 33px rgba(32, 190, 255, 0.09);
  }
  ...
  .icon-link--apple:hover,
  .icon-link--apple:focus,
  .icon-link--apple:active {
    background: #999;
  }

  .icon-link--google:hover,
  .icon-link--google:focus,
  .icon-link--google:active {
    background: #607D8B;
  }
  ...
  /*body {*/
  /*  background: linear-gradient(to left top, rgba(104, 43, 8, 0.2), rgba(139, 103, 35, 0.2));*/
  /*  perspective: 1000px;*/
...
<script src="https://dexito.in/assets/frontend/elegant/script.js"></script>

<?php
$banners = themeConfiguration(get_frontend_settings('theme'), 'banners');
$about_us_banner = $banners['about_us_banner'];
?>
<div id="downloads" class="container text-center margin_120_0" ">
    	<div class=" main_title_2">
  <span><em></em></span>
  <h2>Download Dexito</h2>
  <p><?php echo site_phrase('Dexito_is_now_available'); ?></p>
</div>
<!--<h1>Download Dexito</h1>-->
<!--<p>Dexito is now available</p>-->
<div class="row my-4">
  <div class="col-md-4"></div>
  <div class="col-md-4 my-4" style="margin-top: 20px;">
    <!--new download section-->
    <div class="card-content mb-3">
      <div class="download">
        <div class="download__row">
          <!--<a href="https://www.apple.com/in/app-store/" style="background: black; id="hover"-->
          <!--    class="icon-link btn_1 rounded full-width add_top_6 icon-link--apple">-->
          <!--     <i class="fab fa-google-play"></i>-->
          <!--    <span class="icon-link__text">-->
          <!--        <span class="icon-link__eyebrow">Get it on </span>-->
          <!--        <span class="icon-link__source"> Store</span></a>-->
          <!--</span>-->
          <!--</a>-->
          <a href="https://www.apple.com/in/app-store/" id="hover" class="btn_1  rounded full-width  add_top_6" style="background: #f8f8f8; padding:20px ;">
            <div class="container px-2">
              <div class="row">
                <!-- <div class="col-md-6 mr-0 pr-2"><i class="fab fa-apple fa-4x"></i></div> -->
                ...
                <!-- <div class="col-md-6 ml-0 pt-2"> Get it on
...
<!--		<span><em></em></span>-->
<!--		<h2>Download Dexito</h2>-->
<!--		<p style="text-size:10px">Dexito is now available</p>-->
<!--	</div>-->
<!--	<div class="row justify-content-center">-->
<!--item-->

<!--			<div class="card-content mb-3" style="margin: 8px;">-->
<!--                    <div class="download">-->
<!--                        <div class="download__row">-->
<!--                            <a href="https://www.apple.com/in/app-store/" style="background: black; id="hover"-->
<!--                                class="icon-link btn_1 rounded full-width add_top_6 icon-link--apple">-->
<!--                                <svg class="icon"-->
<!--                                    viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd"-->
<!--                                    clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.414">-->
<!--                                    <path-->
<!--                                        d="M8.112 4.59c.54 0 1.544-.743 2.85-.743 2.25 0 3.135 1.6 3.135 1.6s-1.73.885-1.73 3.032c0 2.42 2.155 3.25 2.155 3.25s-1.507 4.24-3.542 4.24c-.935 0-1.662-.63-2.647-.63-1.004 0-2 .65-2.648.65-1.86 0-4.207-4.03-4.207-7.26 0-3.19 1.988-4.85 3.852-4.85 1.21 0 2.152.69 2.782.69zm.563-3.198C9.725.007 11.188 0 11.188 0s.217 1.303-.827 2.558c-1.11 1.34-2.38 1.12-2.38 1.12s-.24-1.054.7-2.286z"/>-->
<!--                                </svg>-->
<!--                                <span class="icon-link__text">-->
<!--                                    <span class="icon-link__eyebrow">Get it on </span>-->
<!--                                    <span class="icon-link__source">App Store</span></a>-->
<!--                            </span>-->
<!--                            </a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--			<div class="card-contentpy-3 mb-3" style="margin: 8px;">-->
<!--                    <div class="download">-->
<!--                        <div class="download__row">-->
<!--                            <a href="https://www.apple.com/in/app-store/" style="background: black; id="hover"-->
<!--                                class="icon-link btn_1 rounded full-width add_top_6 icon-link--apple">-->
...
<!--                                <span class="icon-link__text">-->
<!--                                    <span class="icon-link__eyebrow">Get it on </span>-->
<!--                                    <span class="icon-link__source">Google Play</span></a>-->
<!--                            </span>-->
<!--                            </a>-->
<!--                        </div>-->
<!--                    </div>-->
