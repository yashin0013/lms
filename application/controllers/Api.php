...
//     $result=$this->api_model->login($login);
...
public function register_post()
  ...
  //DemoClass Api
public function democlass_post()
  {
    $demodata = array(
    ...
    $r = $this->api_model->democlass($demodata);
    $this->response($r);
  }
  
  
    //DemoClass Api
public function democlass_get($user_id)
  {
    $r = $this->api_model->getdemoclass($user_id);
    $this->response($r);
    return $demodata;
 ...
 public function deletedemoclass_post()
  {
    $deletedemodata = array(
      'user_id' => $this->input->post('user_id'),
      'course_id' => $this->input->post('course_id'),
    );
    $r = $this->api_model->deleteDemoClass($deletedemodata);
    $this->response($r);
  }
  //update demo class
  public function updatedemoclass_post()
  {
    $updatedemodata = array(
    ...
    $r = $this->api_model->updateDemoClass($updatedemodata);
    $this->response($r);
  }
...
//   public function democlass_get($course_id = "") {
//     $demo_classes = array();
//     $demo_classes = $this->api_model->getdemoclass($course_id);
//     $this->set_response($demo_classes, REST_Controller::HTTP_OK);
//   }
...
public function support_post()
  {
    ...
    $r = $this->api_model->support($demodata);
    $this->response($r);
  }
  
  public function getsupportdata_get($user_id)
  {
   
    $r = $this->api_model->getsupportdata($user_id);
    $this->response($r);
  }
...
public function liveclass_get($course_id)
  {
    $r = $this->api_model->liveClass($course_id);
    $this->response($r);
