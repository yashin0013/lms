    ...
    <table id="course-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <!-- <td>-->
                <!--    <span class="badge badge-dark-lighten"><?php echo $key['description']; ?></span>-->
                <!--</td>-->
                <!-- <td>-->
                <!--    <span class="badge badge-dark-lighten"><button class="btn btn-danger" type="submit" name="deleteWebinar">Delete</button></span> -->
                <!--</td>-->
