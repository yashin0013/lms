...
<body>
        ...
        <div class="container">
            <div class="navbar-header" style="padding: 0px !important;">
                <a class="navbar-brand" href="#">
                    <img src="https://dexito.in/uploads/system/7d7e61615cc2e2996d2840c781fa483b.png" style="height: 25px;" />
                   Trial Class : <?php echo $course_details['title']; ?>
                </a>
    ...
    function start_zoom() {
        ...
        var MEETING_NUMBER = "<?php
        $webinarId=$this->uri->segment(3);
        $live = $this->db->get_where('zoom', array('id'=> $webinarId))->result_array(); foreach ($live as $key) { echo $key['meet_id'];}?>";
        // var MEETING_NUMBER = "<?php echo $live_class_details['zoom_meeting_id']; ?>";
        // var MEETING_NUMBER = "7264171412";
        // var PASSWORD = "<?php echo $live_class_details['zoom_meeting_password']; ?>";
        var PASSWORD = "<?php $webinarId=$this->uri->segment(3); $live = $this->db->get_where('zoom', array('id'=>  $webinarId))->result_array(); foreach ($live as $key) { echo $key['pass'];}?>";
        //  var PASSWORD = "3t2Qn1";
