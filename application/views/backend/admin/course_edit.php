                        ...
                        <form class="required-form" action="<?php echo site_url('admin/course_actions/edit/' . $course_id); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                            <div id="basicwizard">
                                <ul class="nav nav-pills nav-justified form-wizard-header">
                                    ...
                                    <li class="nav-item">
                                        <a href="#nonpremium" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                ...
                                <div class="tab-content b-0 mb-0">
                                    ...
                                    <div class="tab-pane" id="nonpremium">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="short_description" id="short_description" class="form-control" required><?php echo $course_details['short_description']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="description"><?php echo get_phrase('description'); ?></label>
                                                    <div class="col-md-10">
                                                        <textarea name="description" id="description" class="form-control" required><?php echo $course_details['description']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                            <option value="nonpremium" <?php if ($course_details['level'] == "nonpremium") echo 'selected'; ?>><?php echo get_phrase('Non_premium'); ?></option>
                                                            <option value="premium" <?php if ($course_details['level'] == "premium") echo 'selected'; ?>><?php echo get_phrase('Premium'); ?></option>
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" name="course_overview_url" id="course_overview_url" placeholder="E.g: https://www.youtube.com/watch?v=oBtf8Yglw2w" value="<?php echo $course_details['video_url'] ?>"required>
                                                    </div>
                                                </div>
                                            </div> <!-- end col -->
