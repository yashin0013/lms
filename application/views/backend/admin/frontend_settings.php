        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="iui_online"><?php echo get_phrase('IUI_online_training_program'); ?></label>
                        <textarea name="iui_online" id = "iui_online" class="form-control" rows="5"><?php echo get_frontend_settings('iui_online_training_program'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="iui_hands"><?php echo get_phrase('IUI_hands-on_training'); ?></label>
                        <textarea name="iui_hands" id = "iui_hands" class="form-control" rows="5"><?php echo get_frontend_settings('iui_hands-on_training'); ?></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="ivf_online"><?php echo get_phrase('IVF_online_training_program'); ?></label>
                        <textarea name="ivf_online" id = "ivf_online" class="form-control" rows="5"><?php echo get_frontend_settings('ivf_online_training_program'); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="ivf_hands"><?php echo get_phrase('IVF_hands-on_training'); ?></label>
                        <textarea name="ivf_hands" id = "ivf_hands" class="form-control" rows="5"><?php echo get_frontend_settings('ivf_hands-on_training'); ?></textarea>
                    </div>
                    
                    <!--<div class="form-group">-->
                    <!--    <label for="about_us"><?php echo get_phrase('FAQ'); ?></label>-->
                    <!--    <textarea name="faq" id = "faq" class="form-control" rows="5"><?php echo get_frontend_settings('faq'); ?></textarea>-->
                    <!--</div>-->
...
<script type="text/javascript">
  $(document).ready(function () {
    initSummerNote(['#about_us', '#terms_and_condition', '#privacy_policy', '#cookie_policy', '#iui_online', '#iui_hands', '#ivf_online', '#ivf_hands', '#faq']);
  });
</script>