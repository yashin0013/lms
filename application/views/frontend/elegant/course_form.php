...
<div class="container-fluid bg-dark">
    ...
    <div class="img-content" >	<h1 class="fadeInUp text-light"><span></span><?php echo $course_details['title']; ?></h1></div>
</div>
				 ...
				 <?php endif; ?>		    
														<?php endif; ?>
															<?php echo $lesson['title']; ?>
															  <?php echo $lesson['duration']; ?></span></li>
															    
														<?php else: ?>
															<li> <i class="icon-newspaper"></i>
														<a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$course_id)?>"><?php echo $lesson['title'];?></a>
															</li>
														<?php endif; ?>
													<?php endforeach; ?>
												</ul>
		...
		<div class="box_detail">
			...
			<?php else: ?>
				<?php if ($course_details['is_free_course'] == 1):
					...
					<form method="post" action="<?php echo site_url('home/form_submit/'.slugify($course_details['title']).'/'.$course_details['id']);; ?>" >
                        <div class="form-group">
                          ...
                          <button type="submit" style="background: black;" class="btn_1 full-width">Submit</button>
                          <?php
                                $user_id= $this->session->userdata('user_id');
                          ?>
                          <input type="hidden" name="user_id" value="<?php echo $user_id?>">
					</form>
					<!--<a href="<?php echo site_url('home/form/'.$course_details['id']);; ?>" style="background: black;" class="btn_1 full-width"><?php echo site_phrase('Book_Now'); ?></a>-->
				<?php else: ?>
					<form method="post" action="<?php echo site_url('home/form_submit/'.slugify($course_details['title']).'/'.$course_details['id']);; ?>" >
                        <div class="form-group">
                            <label for="time">Select a Time:</label>
