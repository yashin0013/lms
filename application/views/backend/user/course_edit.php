                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="level" id="level">
                                                            ...
                                                            <!--<option value="nonpremium"><?php // echo get_phrase('non_premium'); ?></option>-->
                                                            <!--<option value="premium"><?php // echo get_phrase('premium'); ?></option>-->
                                                            
                                                            <option value="nonpremium" <?php if ($course_details['level'] == "non_premium") echo 'selected'; ?>><?php echo get_phrase('non_premium'); ?></option>
