...
<section class="customer-logos slider">
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo1.svg'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo2.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo3.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo4.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo5.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo6.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo7.png'; ?>"></div>
      <div class="slide"><img src="<?php echo base_url() . 'uploads/logo/logo8.svg'; ?>"></div>
  ...
  <div class="container-xl">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <ul class="nav justify-content-md-end footer-menu">
          <li class="nav-item">
            <a class="nav-link" href="https://www.facebook.com/internationalfertilityacademy/" target="blank"><i class="fab fa-facebook fa-2x"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://www.linkedin.com/company/international-fertility-academy-online/" target="blank"><i class="fab fa-linkedin fa-2x"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://www.youtube.com/channel/UCvqr5K0N9lW2-Tp6-bcCzgw" target="blank"><i class="fab fa-youtube-square fa-2x"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="https://www.instagram.com/ifa_fertility_courses_online/" target="blank"><i class="fab fa-instagram fa-2x"></i></a>
          </li>
...
<a href="https://api.whatsapp.com/send?phone=918334882060&amp;text=Text here about your  Enquiry%20Demo%20 and Support" class="float">
...
<script src="<?php echo base_url('assets/sliders/font-awesome.min.css'); ?>"></script>	
<script src="<?php echo base_url('assets/sliders/jquery.min.js'); ?>"></script>	
<script src="<?php echo base_url('assets/sliders/owl.carousel.min.css'); ?>"></script>	
<script src="<?php echo base_url('assets/sliders/owl.carousel.min.js'); ?>"></script>	
<script src="<?php echo base_url('assets/sliders/sliders.css'); ?>"></script>
