        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3>
                                        <?php
                                         ...
                                         $status_wise_courses  =  $this->db->get_where('course', array('status' => 'active'))->num_rows();
                        		         $n = $this->db->count_all('course');
                        		         $status_wise_courses++;
                                            echo $n;
					 //$counter = 1;
				...
				// echo $number_of_courses; 
				    ?>
				    <!--<span><?php //echo $number_of_courses['active']->num_rows(); ?></span></h3>--><!-- edit by gunjan-->
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3>
                                             <?php
                            		        $status_wise_courses  =  $this->db->get_where('course', array('status' => 'pending'))->num_rows();
                            		        echo $status_wise_courses++;
                            				    ?>
				                          <!--<span><?php //echo $status_wise_courses['pending']->num_rows(); ?></span>--></h3>
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3>
                                        <?php
                                         $status_wise_courses  =  $this->db->get_where('course', array('is_free_course' => 1))->num_rows();
		                                    echo  $status_wise_courses++;
                                        ?>
                                        <!--<span><?php //echo $this->crud_model->get_free_and_paid_courses('free')->num_rows(); ?></span></h3>-->
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3>
                                        <?php
                                         $status_wise_courses  =  $this->db->get_where('course', array('is_free_course' => null))->num_rows();
                            		        echo $status_wise_courses++;
                                        ?>
                                       <!-- <span><?php //echo $this->crud_model->get_free_and_paid_courses('paid')->num_rows(); ?></span></h3>-->
