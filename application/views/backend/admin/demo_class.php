...
<div class="row" >
            <a href="<?php echo site_url('admin/add_meet'); ?>" class="btn btn-primary">Add New Meet</a>
            <a href="<?php echo site_url('admin/manage_meet'); ?>" class="btn btn-primary ml-2">Manage Meet</a>
            </div>
             </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                 ...
                 <td>
                      ...
                      <div class="dropdown-menu">
                        <?php
                            $t =$this->db->get_where('users', array('is_instructor' => 1))->result_array();
                            foreach ($t as $l) {
                                $url= site_url('admin/teacher/' . $key['id'].'/'.$l['id']); ?>
                            <a class="dropdown-item" href="<?php echo $url; ?>"> <?php echo $l['first_name']; ?> </a>
                           <?php } ?>
                      </div>
                    </div>
                    <!--<span class=""><?php echo $key['assigened_teacher']; ?></span>-->
                </td>
                 <td>
                     <div class="btn-group">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <td>
                 ...
                 <td>
                      <?php
                    // $ZoomId = $this->db->get_where('zoom', array('id'=>  $key['zoom_id']))->result_array();
                    // foreach($ZoomId as $z) :
                    ?>
                    <!--<span class=""><?php echo $z['meet_id']; ?></span>-->
                     <div class="btn-group">
                          <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?php 
                            // echo $key['zoom_id'];
                      ...
                      <div class="dropdown-menu">
                        <?php
                            $z = $this->db->get_where('zoom', array('teacher_id' => $key['assigened_teacher']))->result_array();
                            foreach ($z as $l) {
                                $url= site_url('admin/zoom/' . $key['id'].'/'.$l['id']); ?>
                            <a class="dropdown-item" href="<?php echo $url; ?>"> <?php echo $l['meet_id']; ?> </a>
                           <?php } ?>
                      </div>
                    </div>
                </td>
