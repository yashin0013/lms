                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="user_cv"><?php echo get_phrase('user_cv(only in PDf)'); ?></label>
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="user_cv" name="user_cv" accept=".pdf" >
                                                        <label class="custom-file-label" for="user_cv"><?php echo get_phrase('upload_user_cv'); ?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
