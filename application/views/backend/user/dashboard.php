                        ...
                        <a href="<?php echo site_url('user/payout_report'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $total_pending_amount > 0 ? currency($total_pending_amount) : '₹'.''.$total_pending_amount; ?></span></h3>
                        ...
                        <a href="<?php echo site_url('user/payout_report'); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $requested_withdrawal_amount > 0 ? currency($requested_withdrawal_amount) : '₹'.''.$requested_withdrawal_amount; ?></span></h3>
