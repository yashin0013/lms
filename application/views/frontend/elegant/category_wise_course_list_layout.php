              ...
              <?php if ($course['is_free_course'] == 1):
				...
				// 	$Id=$this->uri->segment(4);
                    ...
                    //         }
                        //  echo var_dump($Id);
                         if($demo){  ?>
                             <a style="background: black;" class="btn_1"><?php echo site_phrase('Booked'); ?></a>
                       	<?php    }else{  ?>
                       	    
                       	    <a href="<?php echo site_url('home/form/'.slugify($course['title']).'/'.$course['id']);; ?>" style="background: black;" class="btn_1"><?php echo site_phrase('Book_Trial'); ?></a>
                          <?php 	} ?>
                ...
                <a href="<?php echo $url; ?>" style="background:black;" class="btn_1" onclick="handleEnrolledButton()"><?php echo site_phrase('Enrol'); ?></a>
              <?php } else: ?>
