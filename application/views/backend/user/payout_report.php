        ...
        <div class="card text-white bg-danger">
            <div class="card-body">
                ...
                <h3 class="mt-3 mb-3">
                    ...
                    <?php echo $total_pending_amount > 0 ? currency($total_pending_amount) : '₹'.''.$total_pending_amount; ?>
                </h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
        ...
        <div class="card text-white bg-success">
            <div class="card-body">
                ...
                <h3 class="mt-3 mb-3">
                    ...
                    <?php echo $total_payout_amount > 0 ? currency($total_payout_amount) : '₹'.$total_payout_amount; ?>
                </h3>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
        ...
        <div class="card text-white bg-info">
            <div class="card-body">
                ...
                <h5 class="text-white font-weight-normal mt-0" title="<?php echo get_phrase('requested_withdrawal_amount'); ?>"><?php echo get_phrase('requested_withdrawal_amount'); ?></h5>
                    ...
                    <?php else: ?>
                        <h3 class="mt-3 mb-3"><span class="text-white"><i class="mdi mdi-arrow-down-bold"></i></span> <?php echo '₹'.''.$requested_withdrawal_amount; ?></h3>
                    <?php endif; ?>
            </div> <!-- end card-body-->
        </div> <!-- end card-->
    </div> <!-- end col-->
