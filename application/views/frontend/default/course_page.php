        ...
        <div class="course-sidebar natural">
          ...
          <div class="course-sidebar-text-box">
            ...
            <?php else : ?>
              ...
              <?php else : ?>
                <div class="buy-btns">
                  <a href="javascript::" class="btn btn-buy-now" id="course_<?php echo $course_details['id']; ?>" onclick="handleBuyNow(this)"><?php echo site_phrase('buy_noww'); ?></a>
                  ...
                  <?php else : ?>
                    <button class="btn btn-add-cart" type="button" id="<?php echo $course_details['id']; ?>" onclick="handleCartItems(this)"><?php echo site_phrase('add_to_cartt'); ?></button>
                  <?php endif; ?>
                </div>
              <?php endif; ?>
            <?php endif; ?>
