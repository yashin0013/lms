...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('Students List'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
              <h4 class="mb-3 header-title"><?php echo get_phrase('Students List'); ?></h4>
                      ...
                      <table id="example" class="display row-border nowrap table-striped responsive-utilities jambo_table">
                          <thead>
                              <tr>
                                  ...
                                  <th><?php echo get_phrase('Mobie'); ?></th>
                                  <th><?php echo get_phrase('Meet Id'); ?></th>
                          ...
                          <tbody>
                             	<?php
                             	    $ctr=1;
                					$city = $this->db->get('guests')->result_array();
                                    foreach ($city as $key) {
                                        ?>
                                <tr class="gradeU">
                                      <td><?php echo $ctr; ?>.</td>
                                      <td><b><?php echo $key['guest_name']; ?></b></td>
                                      <td><b><?php echo $key['email']; ?></b></td>
                                      <td><b><?php echo $key['mobile']; ?></b></td>
                                      <td><b><?php echo $key['meet_id']; ?></b></td>
